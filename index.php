...
<header>
    <nav>
        <ul>
            ...
            <li><a href="index.php">Hỗ Trợ</a></li>
            <li><a href="datnhanh.php">Đặt Khách Sạn Nhanh</a></li>
            <li>
            ...
            <div class="user-actions">
                <?php if (isset($_SESSION['tentaikhoan'])): ?>
                    <div class="user-info">
                        <a href="#" onclick="toggleBookingHistory()">Xem Lịch Sử Đặt</a>
...
<div class="hotel-grid">
    ...
    if ($result->num_rows > 0) {
        while($row = $result->fetch_assoc()) {
            ...
            echo "<img src='" . $row["hinhanh"] . "' alt='Hình Ảnh Khách Sạn' style='width: 150px; height: auto;'>";
